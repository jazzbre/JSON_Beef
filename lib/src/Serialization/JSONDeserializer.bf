...
namespace JSON_Beef.Serialization
{
	public static class JSONDeserializer
	{
		...
		private static Result<void, DESERIALIZE_ERRORS> DeserializeArray(JSONArray jsonArray, Object object)
		{
			...
			for (int i = 0; i < jsonArray.Count; i++)
			{
				...
				if (TypeChecker.IsTypeList(paramType) && (paramType.CreateObject() case .Ok(let innerList)))
				{
					...
					jsonArray.Get<JSONArray>(i, ref innerJsonArray);
				...
				{
					var jsonObject = scope JSONObject();
					jsonArray.Get<JSONObject>(i, ref jsonObject);
		...
		private static Result<void, DESERIALIZE_ERRORS> AddPrimitiveToArray(Type type, JSONArray jsonArray, int i, Object obj, MethodInfo addMethod)
		{
			...
			case typeof(int):
				int dest = default;
				jsonArray.Get<int>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(int8):
				int8 dest = default;
				jsonArray.Get<int8>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(int16):
				int16 dest = default;
				jsonArray.Get<int16>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(int32):
				int32 dest = default;
				jsonArray.Get<int32>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(int64):
				int64 dest = default;
				jsonArray.Get<int64>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(uint):
				uint dest = default;
				jsonArray.Get<uint>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(uint8):
				uint8 dest = default;
				jsonArray.Get<uint8>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(uint16):
				uint16 dest = default;
				jsonArray.Get<uint16>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(uint32):
				uint32 dest = default;
				jsonArray.Get<uint32>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(uint64):
				uint32 dest = default;
				jsonArray.Get<uint32>(i, ref dest);
			...
			case typeof(char8):
				char8 dest = default;
				jsonArray.Get<char8>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(char16):
				char16 dest = default;
				jsonArray.Get<char16>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(char32):
				char32 dest = default;
				jsonArray.Get<char32>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(float):
				float dest = default;
				jsonArray.Get<float>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(double):
				double dest = default;
				jsonArray.Get<double>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(bool):
				bool dest = default;
				jsonArray.Get<bool>(i, ref dest);
				addMethod.Invoke(obj, dest);
			case typeof(String):
				String dest = default;
				jsonArray.Get<String>(i, ref dest);
